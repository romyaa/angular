...
export class DetailsComponent {
  ...
  ngOnInit(){
    console.log(this.activatedRoute.snapshot.params['Game_id']); 

    const prod_id =this.activatedRoute.snapshot.params['Game_id']

    this.prod_details = this.prod_List.find((prod :any) => prod.id  == prod_id )
